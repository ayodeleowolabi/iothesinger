...
export default function EPKPage() {
    ...
    <>
      <style>{`
        ...
        :root {
          ...
          --epk-rule:    rgba(240,236,228,0.18);
        }
        ...
        .epk-font-serif { font-family: 'Inter', sans-serif; font-weight: 400; }
        ...
        .epk-flink { font-size: 10px; letter-spacing: 0.12em; text-transform: uppercase; color: var(--epk-darkpaper); text-decoration: none; transition: color 0.2s; }
        ...
        .epk-press-quote { font-family: 'Libre Baskerville', Georgia, serif; font-size: 1.2rem; line-height: 1.5; color: var(--epk-paper); border-left: 2.5px solid var(--epk-accent); padding-left: 1.1rem; margin: 0 0 0.5rem 0; }
        .epk-press-source { font-size: 10px; letter-spacing: 0.14em; text-transform: uppercase; color: var(--epk-dim); padding-left: 1.1rem; margin: 0 0 1.4rem 0; display: block; text-decoration: none; }
      ...
      <div className="epk-page">
        ...
        <section style={{ width: "100%", padding: "4rem 2rem", boxSizing: "border-box", borderBottom: "1px solid var(--epk-rule)" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(2, minmax(280px, 420px))", justifyContent: "center", gap: "3rem", maxWidth: "1000px", margin: "0 auto" }}>
            {[
              ...
              <div key={video.title} style={{ border: "1px solid var(--epk-rule)", background: "#0c0b09" }}>
                ...
                <div style={{ padding: "0.75rem 1rem", borderTop: "1px solid var(--epk-rule)" }}>
                  <p style={{ fontFamily: "'Libre Baskerville', Georgia, serif", fontSize: 13, color: "var(--epk-paper)", margin: 0 }}>
                    {video.title}
                  </p>
                  <p style={{ fontSize: 10, letterSpacing: "0.1em", textTransform: "uppercase", color: "var(--epk-dim)", margin: "5px 0 0" }}>
                    {video.location}
                  </p>
                </div>
              </div>
        ...
        <div style={{ margin: "3rem 2rem 0", borderBottom: "1px solid var(--epk-rule)" }}>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", alignItems: "start" }}>
            <div style={{ borderRight: "1px solid var(--epk-rule)", padding: "2rem" }}>
              {STATS.map((s) => (
        ...
        <div className="epk-section">
          <p className="epk-font-display" style={{ fontSize: "clamp(2rem, 1vw, 10rem)", lineHeight: 0.9, color: "var(--epk-accent)", textAlign: "center", letterSpacing: "-0.02em", margin: 20 }}>
            About
          </p>
          <div style={{ fontSize: 14, color: "rgba(240,236,228,0.7)", textAlign: "center", lineHeight: 1.9, maxWidth: 900, margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 1, background: "var(--epk-rule)", border: "1px solid var(--epk-rule)", marginBottom: "1.5rem" }}>
            {CONFIGS.map((c) => (
              <div key={c.title} className="epk-config-block">
                ...
                <p style={{ fontSize: 12, color: "var(--epk-paper)", lineHeight: 1.6, margin: 0 }}>{c.desc}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div style={{ borderBottom: "1px solid var(--epk-rule)" }}>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr" }}>
            <div style={{ borderRight: "1px solid var(--epk-rule)" }}>
              ...
              <div style={{ padding: "0.75rem 1rem", borderTop: "1px solid var(--epk-rule)" }}>
                <p style={{ fontSize: 13, letterSpacing: "0.14em", textTransform: "uppercase", color: "var(--epk-darkpaper)", margin: 0 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "1rem", alignItems: "center", padding: "2.5rem 2rem" }}>
            ...
            <p className="epk-font-serif" style={{ fontSize: "1.5rem", color: "var(--epk-paper)", lineHeight: 1.45, maxWidth: 900, textAlign: "center", margin: 0 }}>
  ...
  Download press kit
        ...
        <div style={{ padding: "1.25rem 2rem", borderTop: "1px solid var(--epk-rule)", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <span className="epk-font-display" style={{ fontSize: "1.2rem", color: "var(--epk-dimmer)" }}>IO</span>
