  ...
  return (
    <>
      <style>{`
        ...
        .epk-font-body { font-family: 'Josefin Sans', sans-serif; font-weight: 300; }
        ...
        .epk-vid-more { font-size: 10px; letter-spacing: 0.14em; text-transform: uppercase; color: var(--epk-accent); text-decoration: none; display: inline-flex; align-items: center; gap: 5px; border-bottom: 1px solid transparent; margin-top: 1rem; transition: border-color 0.2s; font-family: 'Josefin Sans', sans-serif; }
        ...
        /* Grain texture — hero overlay */
        .epk-grain {
          position: absolute;
          inset: 0;
          pointer-events: none;
          opacity: 0.35;
          background-image: url("data:image/svg+xml,<svg viewBox='0 0 200 200' xmlns='http://www.w3.org/2000/svg'><filter id='n'><feTurbulence type='fractalNoise' baseFrequency='0.85' numOctaves='4' stitchTiles='stitch'/></filter><rect width='100%' height='100%' filter='url(%23n)' opacity='0.07'/></svg>");
        }
      `}</style>
      ...
      <div className="epk-page">
        ...
        <section style={{ width: "100%", padding: "4rem 2rem", boxSizing: "border-box", borderBottom: "0.5px solid var(--epk-rule)" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(2, minmax(280px, 420px))", justifyContent: "center", gap: "3rem", maxWidth: "1000px", margin: "0 auto" }}>
            {[
              {
                title: "\u201cI Got a Ticket & Covers\u201d",
                location: "Adams Morgan Porchfest · Washington DC · 2026",
                src: "https://customer-bhx35sxtf94ncmdm.cloudflarestream.com/154c01d9c35239191ac227878658f584/iframe?poster=https%3A%2F%2Fcustomer-bhx35sxtf94ncmdm.cloudflarestream.com%2F154c01d9c35239191ac227878658f584%2Fthumbnails%2Fthumbnail.jpg%3Ftime%3D%26height%3D600",
              },
              {
                title: "\u201cTomorrow\u201d",
                location: "Songbyrd DC · 2026",
                src: "https://customer-bhx35sxtf94ncmdm.cloudflarestream.com/718213477ee3be05bb2069d1ff0f0b46/iframe?poster=https%3A%2F%2Fcustomer-bhx35sxtf94ncmdm.cloudflarestream.com%2F718213477ee3be05bb2069d1ff0f0b46%2Fthumbnails%2Fthumbnail.jpg%3Ftime%3D%26height%3D600",
              },
              {
                title: "Just the Two of Us",
                location: "Adams Morgan Porchfest · Washington DC · 2026",
                src: "https://customer-bhx35sxtf94ncmdm.cloudflarestream.com/e3b6bc542e309640daa70ca4c006553a/iframe?poster=https%3A%2F%2Fcustomer-bhx35sxtf94ncmdm.cloudflarestream.com%2Fe3b6bc542e309640daa70ca4c006553a%2Fthumbnails%2Fthumbnail.jpg%3Ftime%3D%26height%3D600",
              },
              {
                title: "\u201cIt\u2019s Too Much\u201d",
                location: "Washington DC · 2026",
                src: "https://customer-bhx35sxtf94ncmdm.cloudflarestream.com/6edea4301a0c51cf1b30096456616d59/iframe?poster=https%3A%2F%2Fcustomer-bhx35sxtf94ncmdm.cloudflarestream.com%2F6edea4301a0c51cf1b30096456616d59%2Fthumbnails%2Fthumbnail.jpg%3Ftime%3D%26height%3D600",
              },
            ].map((video) => (
              <div key={video.title} style={{ border: "0.5px solid var(--epk-rule)", background: "#0c0b09" }}>
                ...
                <div style={{ padding: "0.75rem 1rem", borderTop: "0.5px solid var(--epk-rule)" }}>
                  <p style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: 15, color: "var(--epk-paper)", margin: 0, fontStyle: "italic" }}>
                    {video.title}
                  </p>
                  <p style={{ fontSize: 10, letterSpacing: "0.1em", textTransform: "uppercase", color: "var(--epk-dim)", margin: "5px 0 0", fontFamily: "'Josefin Sans', sans-serif" }}>
                    {video.location}
                  </p>
                </div>
              </div>
        ...
        <div style={{ margin: "3rem 2rem 0", borderBottom: "0.5px solid var(--epk-rule)" }}>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", alignItems: "start" }}>
            <div style={{ borderRight: "0.5px solid var(--epk-rule)", padding: "2rem" }}>
              {STATS.map((s) => (
                <div key={s.label} className="epk-stat-block">
                  ...
                  <p style={{ fontSize: 9, letterSpacing: "0.16em", textTransform: "uppercase", color: "var(--epk-dim)", lineHeight: 1.4, marginTop: 6, whiteSpace: "pre-line", fontFamily: "'Josefin Sans', sans-serif" }}>
                    {s.label}
                  </p>
                </div>
              ))}
        ...
        <div className="epk-section">
          <p className="epk-font-display" style={{ fontSize: "clamp(2rem, 4vw, 5rem)", lineHeight: 0.9, color: "var(--epk-accent)", textAlign: "center", letterSpacing: "-0.02em", margin: "0 0 2rem" }}>
            About
          </p>
          <div style={{ fontSize: 14, color: "rgba(240,236,228,0.7)", textAlign: "center", lineHeight: 1.9, maxWidth: 900, margin: "0 auto", fontFamily: "'Josefin Sans', sans-serif" }}>
            ...
            <p style={{ marginTop: "0.9rem" }}>
              ...
              She arrives in 2026 with her debut full-length{" "}
              <em style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "1.05em" }}>Severed</em>: a record about what it costs to leave the life you
            ...
            <p style={{ marginTop: "0.9rem" }}>
              ...
              across 7 shows, and has been featured in the Washington
        ...
        <div className="epk-section">
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 1, background: "var(--epk-rule)", border: "0.5px solid var(--epk-rule)", marginBottom: "1.5rem" }}>
            {CONFIGS.map((c) => (
              <div key={c.title} className="epk-config-block">
                <p style={{ fontSize: 9, letterSpacing: "0.2em", textTransform: "uppercase", color: "var(--epk-accent)", marginBottom: "0.4rem", fontFamily: "'Josefin Sans', sans-serif" }}>
                  {c.title}
                </p>
        ...
        <div style={{ borderBottom: "0.5px solid var(--epk-rule)" }}>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr" }}>
            <div style={{ borderRight: "0.5px solid var(--epk-rule)" }}>
              <div style={{ position: "relative", height: 480, overflow: "hidden" }}>
                <Image
                  src="/audience-dc-photo.jpg"
                  alt="IO live — Songbyrd DC Spring 2026"
                  fill
                  style={{ objectFit: "cover", objectPosition: "center" }}
                />
              </div>
              <div style={{ padding: "0.75rem 1rem", borderTop: "0.5px solid var(--epk-rule)" }}>
                <p style={{ fontSize: 11, letterSpacing: "0.14em", textTransform: "uppercase", color: "var(--epk-darkpaper)", margin: 0, fontFamily: "'Josefin Sans', sans-serif" }}>
                  Songbyrd DC · Spring 2026
                </p>
              </div>
            </div>
            <div>
              <div style={{ position: "relative", height: 480, overflow: "hidden" }}>
                <Image
                  src="/audience-spain.jpg"
                  alt="IO live — Bar Mutante Sevilla Fall 2025"
                  fill
                  style={{ objectFit: "cover", objectPosition: "center" }}
                />
              </div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "1rem", alignItems: "center", padding: "2.5rem 2rem" }}>
            ...
            <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
              ...
              <Link href="https://iothesinger.com/info" target="_blank" className="epk-btn-secondary">
                Download press kit
              </Link>
            </div>
          </div>
        ...
        {/* ── FOOTER ── */}
        <div style={{ padding: "1.25rem 2rem", borderTop: "0.5px solid var(--epk-rule)", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
